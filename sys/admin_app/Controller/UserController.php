...
//                                'application' => array(),'licence' => array());
        ...
        $arrSearchParam = array('code' => null,'company_profile_id' => null, 'public_flg' => -1,'phone' => null,'email' => null,
                                'keywords' => null,'area' => array(), 'event_category' => array(),'employment' => array(),
                                'application' => array(),'licence' => array(), 'id' => null, 'name' => null, 'user_rank' => 'all', 'address' => null);
	...
	public function loginUser($id) {
		...
		$auth_user = CakeSession::read($sessionKey);
		$auth_user['u_id'] = $id;
		
		CakeSession::write($sessionKey, $auth_user);
		
		return $this->redirect('http://dl-mart.com/mypage');
	}
